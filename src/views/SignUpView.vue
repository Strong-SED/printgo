<template>
  <div class="m-auto w-8/12 flex flex-row my-20 shadow-lg rounded-2xl px-4 py-6 overflow-hidden">
    <div class=" w-1/2 h-auto py-6 img_side">
      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="824.80767"
        height="438.31651" viewBox="0 0 824.80767 438.31651" role="img" artist="Katerina Limpitsouni"
        source="https://undraw.co/" class=" w-full h-full">
        <path id="b4c13b4e-8ef9-4732-a242-1b77a57c7078-682" data-name="Path 141"
        ...
        <path id="f7d611df-d029-4cc6-9561-be5a6829cf65-689" data-name="Path 154"
          ...
          transform="translate(-187.59617 -230.84175)" fill="#6c63ff" />
        <path id="b2be1aaf-9241-4aa1-a473-dbb8e8dcff3c-690" data-name="Path 154"
        ...
        <path id="e2582065-92bf-48dc-a28d-04f42179e35f-691" data-name="Path 155"
        ...
        <path id="bb678cb9-7d76-4fbb-a84c-c380d6521528-692" data-name="Path 156"
          ...
          transform="translate(-187.59617 -230.84175)" fill="#fff" />
        <path id="a9697f3a-b5f3-4f74-8277-57e15506e4dd-693" data-name="Path 157"
    ...
    <form action="" class=" w-1/2 text-center" :onsubmit="submitForm">
      <h2 class=" text-center text-4xl font-bold text-slate-700 p-8">Inscription</h2>

      <div class=" w-full text-center py-8 relative">

        <input type="text" name="username"
          class="champ w-3/4 rounded-full p-6 text-lg text-slate-700 border-2 border-slate-700 py-4"
      ...
      <button
        class="'flex items-center px-10 py-4 rounded-full border-2 border-slate-700 transition-all duration-700 text-xl font-bold text-slate-100 bg-slate-700 hover:text-slate-700 hover:bg-slate-100">S'inscrire</button>
...
.img_side {
  position: relative;
  animation: BackInDown 2s ease-in-out forwards;
}
